...
class SearchScreen extends StatelessWidget {
  ...
  Expanded buildSearchResultCards(Function sh) {
    return Expanded(
      child: Obx(
        () => ListView.separated(
      ...
      child: Obx(() => RichText(
            ...
            text: TextSpan(children: <TextSpan>[
              TextSpan(
                ...
                text: "${widgetCtrl.mealsCount} menu items found on ",
              ),
              TextSpan(
                style: context.theme.textTheme.caption!.copyWith(
                    fontSize: Dimens.k12, fontWeight: FontWeight.w600),
                text: "${widgetCtrl.searchTextEditingController.text} ",
              ),
              TextSpan(
                style: context.theme.textTheme.caption!
                    .copyWith(fontSize: Dimens.k12),
