...
class BankDetailsScreen extends StatelessWidget {
  final BankDetailsScreenController widgetCtrl =
      Get.put(BankDetailsScreenController());
  @override
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: SecondaryAppBar(title: "Bank Details")),
        body: ListView(
            ...
            children: [
              InputFieldWrapper(
                ...
                child: SecondaryTextField(
                    hintText: "John", hintTextColor: FYColors.subtleBlack),
              ),
              ...
              FYTextButton(
                  text: "Save and Close", onPressed: widgetCtrl.gotoNextScreen),
            ]),
      ),
    );
  }
