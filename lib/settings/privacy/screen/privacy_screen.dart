  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(preferredSize: Size(sw(20), sh(46.41)), child: SecondaryAppBar(title: "Privacy Policy")),
        body: ListView(padding: EdgeInsets.symmetric(horizontal: sw(24), vertical: sh(44)), children: [
          Text(
...
Mauris leo quis tincidunt faucibus in. Aenean mi suscipit mus at. Mauris imperdiet urna, ac malesuada aenean mauris, ac ante. Tortor ligula diam pretium nunc quis.""",
            style: context.theme.textTheme.caption!
                .copyWith(fontSize: sh(Dimens.k16), fontWeight: FontWeight.w400, color: FYColors.lighterBlack2),
          ),
        ]),
      ),
    );
