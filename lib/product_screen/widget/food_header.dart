...
class FoodTableHeader extends StatelessWidget {
  ...
  FoodTableHeader({this.leading = "", this.trailing = "", this.hideAsterisk = true});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        Text(/* "Single option" */ trailing, style: context.theme.textTheme.headline4!.copyWith(fontSize: sh(Dimens.k12))),
      ],
    );
  }
}
