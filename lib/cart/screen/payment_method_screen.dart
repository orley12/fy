...
class PaymentMethodScreen extends StatelessWidget {
          ...
          Row(
            children: [
              PaymentMethodCard(
                ...
                cardValueText:
                    TextSpan(style: context.theme.textTheme.headline4!.copyWith(fontSize: sh(Dimens.k12)), text: "Blc: "),
                cardKeyText: TextSpan(
                  style: context.theme.textTheme.caption!
                      .copyWith(fontSize: sh(Dimens.k12), fontWeight: FontWeight.w800, color: FYColors.mainBlue),
                  text: "N22,500",
                ),
              ),
              SizedBox(width: sw(3)),
              PaymentMethodCard(
                cardTitle: AutoSizeText("My Points",
                    style: context.theme.textTheme.caption!
                        .copyWith(fontSize: sh(Dimens.k16), fontWeight: FontWeight.w700, color: FYColors.darkerBlack2)),
                cardValueText:
                    TextSpan(style: context.theme.textTheme.headline4!.copyWith(fontSize: sh(Dimens.k12)), text: "Pts: "),
                cardKeyText: TextSpan(
                  style: context.theme.textTheme.caption!
                      .copyWith(fontSize: sh(Dimens.k12), fontWeight: FontWeight.w800, color: FYColors.mainBlue),
                  text: "12",
              ...
              PaymentMethodCard(
                cardTitle: Center(
                  child: Image.asset(Images.pay_stack, height: sh(25.24), width: sw(25.24)),
                ),
                cardValueText:
                    TextSpan(style: context.theme.textTheme.headline4!.copyWith(fontSize: sh(Dimens.k12)), text: "Pts: "),
                cardKeyText: TextSpan(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                buildPaymentMethodCardItem(context, "Order from:", "Omowunmi O."),
                SizedBox(height: sh(24.0)),
                buildPaymentMethodCardItem(context, "Order ID:", "FD7549Y8"),
                SizedBox(height: sh(24.0)),
                buildPaymentMethodCardItem(context, "Order Date:", "29/07/2021   05:22PM"),
              ],
            ),
          ),
  ...
  buildPaymentMethodCardItem(BuildContext context, String title, String description) {
    Function sh = sHeight(context);
    Function sw = sWidth(context);
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            description,
            style: context.theme.textTheme.caption!
                .copyWith(fontSize: sh(12), fontWeight: FontWeight.w700, color: FYColors.mainBlue),
          ),
        ),
      ],
    );
