...
class LargeOrderBarner extends StatelessWidget {
  final HomeTabFrontPanelController widgetCtrl = Get.put(HomeTabFrontPanelController());
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Center(
            child: LocalTheme(
              child: FYTextButton(text: "Order Now", onPressed: widgetCtrl.gotoLargeOrderScreen, fontSize: Dimens.k16),
              buttonStyle: whiteTextButtonStyle.copyWith(
                minimumSize: MaterialStateProperty.all<Size>(Size(Dimens.k136, Dimens.k47)),
              ),
              buttonTextStyle: context.theme.textTheme.headline3!.copyWith(fontWeight: FontWeight.w400),
            ),
          ),
        ],
      ),
