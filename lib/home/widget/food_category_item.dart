...
class FoodCategoryItem extends StatelessWidget {
  ...
  FoodCategoryItem(this.foodCategory,
      {this.isSelected = false,
      this.onSelected,
      required this.selectedFoodCategoryIndex});
  ...
  Widget build(BuildContext context) {
    ...
    return FYButton(
        ...
        children: [
          Container(
            decoration: BoxDecoration(
              border: Border.all(
                  color: isSelected! ? FYColors.mainGreen : Colors.transparent),
      ...
      onTap: () => onSelected == null
          ? null
          : onSelected!(selectedFoodCategoryIndex, foodCategory),
    );
  }
}
